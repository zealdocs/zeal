...
if(GIT_DESCRIBE_RESULT AND NOT GIT_DESCRIBE_RESULT EQUAL 0)
    message(NOTICE "No Git tags found, commit SHA will be used for version.")
    unset(GIT_DESCRIBE_RESULT)
    return()
endif()
unset(GIT_DESCRIBE_RESULT)
...
if(VERSION_UPDATE_FROM_GIT)
    ...
    set(${PROJECT_NAME}_VERSION
        ${${PROJECT_NAME}_GIT_VERSION_MAJOR}.${${PROJECT_NAME}_GIT_VERSION_MINOR}.${${PROJECT_NAME}_GIT_VERSION_PATCH}
    )
